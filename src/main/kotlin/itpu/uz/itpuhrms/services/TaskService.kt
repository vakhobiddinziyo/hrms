...
//    override fun getAll(stateName: String?, pageable: Pageable): Page<TaskStateResponse> {
//        val stateQuery = stateName?.let { "'$stateName'" }
...
//                    and ($stateQuery is null or s.name ilike concat ('%', $stateQuery ,'%'))
//                    order by  t.ordered, s.ordered
//                    limit ${pageable.pageSize} offset ${pageable.offset}
//
//        """.trimIndent()
//
...
//                taskOrder = rs.getShort("task_order"),
//                taskPriority = TaskPriority.valueOf(rs.getString("priority")),
...
//            )
//        }
//        val totalElement = jdbcTemplate.queryForObject(totalQuery, Integer::class.java)!!.toLong()
//        return PageImpl(result, pageable, totalElement)
//    }
    ...
    //    private fun createTaskPriorityHistory(task: Task, owner: User) {
//        if (task.priority != TaskPriority.NONE) {
//            actionHistoryService.create(
//                TaskActionHistoryRequest(
//                    task.id!!,
//                    owner.id!!,
//                    TaskAction.SET_TASK_PRIORITY,
//                    taskPriority = task.priority
//                )
//            )
//        }
...
//
//    private fun createTaskDueDateHistory(task: Task, owner: User) {
//        task.endDate?.let {
//            actionHistoryService.create(
//                TaskActionHistoryRequest(
//                    task.id!!,
//                    owner.id!!,
//                    TaskAction.SET_DUE_DATE,
//                    dueDate = task.endDate
//                )
//            )
//        }
//    }
//
//    private fun createTaskStartDateHistory(task: Task, owner: User) {
//        task.startDate?.let {
//            actionHistoryService.create(
//                TaskActionHistoryRequest(
//                    task.id!!,
//                    owner.id!!,
//                    TaskAction.SET_START_DATE,
//                    startDate = task.startDate
//                )
//            )
//        }
//    }
//
//    private fun createTaskEstimateTimeHistory(task: Task, owner: User) {
//        task.timeEstimateAmount?.let {
//            actionHistoryService.create(
//                TaskActionHistoryRequest(
//                    task.id!!,
//                    owner.id!!,
//                    TaskAction.TIME_AMOUNT_ESTIMATED,
//                    timeEstimateAmount = task.timeEstimateAmount
//                )
//            )
//        }
