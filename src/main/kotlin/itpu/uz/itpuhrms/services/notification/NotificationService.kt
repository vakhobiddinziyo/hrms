...
import itpu.uz.itpuhrms.bot.MessageRepository
import itpu.uz.itpuhrms.bot.OtpDto
...
import itpu.uz.itpuhrms.services.comment.CommentRepository
...
import itpu.uz.itpuhrms.services.timeTracking.TimeTrackingRepository
...
import itpu.uz.itpuhrms.utils.Constants.OTP_EXPIRE_MIN
import itpu.uz.itpuhrms.utils.Constants.OTP_MESSAGE_INTERVAL_LIMIT_MIN
import itpu.uz.itpuhrms.utils.Constants.OTP_MESSAGE_LIMIT
import itpu.uz.itpuhrms.utils.Constants.OTP_MESSAGE_RETRY_INTERVAL_LIMIT_MIN
...
class TelegramNotificationServiceImpl(
    ...
    override fun getHash(): OtpDto {
        ...
        val count = messageRepository.getLastMessagesAmount(employee.id!!, Constants.OTP_MESSAGE_INTERVAL_LIMIT_MIN, BOT_USERNAME)
