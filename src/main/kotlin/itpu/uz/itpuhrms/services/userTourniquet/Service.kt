...
import itpu.uz.itpuhrms.services.file.FileService
import itpu.uz.itpuhrms.services.hikvision.EventResponse
import itpu.uz.itpuhrms.services.hikvision.HikvisionUserTourniquetRequest
...
import itpu.uz.itpuhrms.services.userTourniquetResult.UserTourniquetResultRepository
import itpu.uz.itpuhrms.services.workingDate.DailyAttendanceResponse
...
interface UserTourniquetService {
    fun create(request: HikvisionUserTourniquetRequest, image: MultipartFile? = null): String
...
class UserTourniquetServiceImpl(
    ...
    override fun create(request: HikvisionUserTourniquetRequest, image: MultipartFile?): String {
